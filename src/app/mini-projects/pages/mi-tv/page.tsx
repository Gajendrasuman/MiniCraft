...
export default function MiTv(): React.ReactNode {
    ...
    return (
        <main className="text-text w-screen" style={{ height: "calc(100vh - 76px)" }}>
            <div className={`container h-full w-full max-sm:scale-50 max-md:scale-75 flex justify-center items-center gap-10`}>

                <div className="remote relative h-[35rem] w-40 rounded-3xl bg-black">
                    ...
                    <div className="volumm1 cursor-pointer relative top-[30%] left-1/2 -translate-x-1/2 w-[15%] h-[15%] bg-white text-black flex flex-col justify-between items-center rounded-full">
                        <span onClick={() => setVolume(volume >= 100 ? 100 : volume + 10)} className="block h-10 w-full text-center" >+</span>
                        <span onClick={() => setVolume(volume <= 0 ? 0 : volume - 10)} className="block h-10 w-full text-3xl leading-[3rem] text-center">-</span>
                    </div>
                    <SiXiaomi className="top-[40%] text-zinc-800 relative left-1/2 -translate-x-1/2" size={25} />
                </div>

                <div className="tv relative w-fit z-20">
                    ...
                    <div className="stand z-[1] relative left-14 bottom-2"><div className="h-8 w-2 rotate-45 absolute bg-zinc-900 rounded-full"></div> <div className="h-8 w-2 -rotate-45 left-[18px] absolute bg-zinc-900 rounded-full"></div></div>
                    <div className="stand z-[1] relative left-3/4 bottom-2"><div className="h-8 w-2 rotate-45 absolute bg-zinc-900 rounded-full"></div> <div className="h-8 w-2 -rotate-45 left-[18px] absolute bg-zinc-900 rounded-full"></div></div>
                </div>
{/* 
                <div className="table absolute w-[28rem] z-10 top-44 left-[60%] -translate-x-[92%]">
